...
test("the header keeps a compact quote action available and closes its mobile menu with Escape", async () => {
  const source = await readProjectFile("src/components/SiteLayout.jsx");
